"""
runner function for beta-variational autoencoder 
Timo Flesch, 2017
"""
# external
import numpy      as np
...
# custom
from bvae.model          import         myModel
...
def runBVAE(x_train,x_test):
    ...
    with tf.Session() as sess:      
        ...
        if FLAGS.do_training:
            ...
            print("{} Now training beta Variational Autoencoder, LR: {} , EPs: {}, BS: {}"
            ...
            print("Now evaluating beta Variational Autoencoder")
